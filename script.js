const OperatingSystem = {
  version: "Microsoft Windows [versão 20.0.16299.125]",
  copyRight: "(c) 2017 Microsoft Corportion. Todos os direitos reservados."
}
...
function help() {
  Terminal.input += newLine() +
    "Para obter mais informações sobre um comando específico," + newLine() +
    "digite HELP nome_do_comando" + newLine() +
    "CD" + nbsp(13) + "Exibe o nome do diretório atual ou faz alterações nele." + newLine() +
    // "CHDIR" + nbsp(10) + "Exibe o nome do diretório atual ou faz alterações nele." + newLine() +
    "CLS" + nbsp(12) + "Limpa a tela." + newLine() +
    "CMD" + nbsp(12) + "Inicia uma nova instância do interpretador de comandos do" + newLine() +
    "" + nbsp(15) + "Windows." + newLine() +
    "COLOR" + nbsp(10) + "Define as cores padrão do primeiro plano e da tela de fundo" + newLine() +
    ...
    "EXIT" + nbsp(11) + "Sai do programa CMD.EXE (interpretador de comandos)." + newLine() +
    "HELP" + nbsp(11) + "Fornece informações de ajuda sobre comandos do Windows." + newLine() +
    "TIME" + nbsp(11) + "Exibe ou ajusta a hora do sistema." + newLine() +
    // "TITLE" + nbsp(10) + "Define o título da janela para uma sessão do CMD.EXE." + newLine() +
    "VER" + nbsp(12) + "Exibe a versão do Windows." + newLine() +
    "" + newLine() +
    "Para obter mais informações sobre ferramentas, consulte a referência a linhas de comando na ajuda online." + newLine()
    execute();
}
function cd() {
...
function color() {
  ...
  let colorHelp = "Configura as cores padrão de primeiro plano e tela de fundo do console." + newLine() +
    "" + newLine() +
    "COLOR [attr]" + newLine() +
    "" + newLine() +
    "" + nbsp(2) + "attr" + nbsp(8) + "Especifica os atributos de cor da saída do console" + newLine() +
    "" + newLine() +
